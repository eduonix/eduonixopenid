...
public class SecureUtils {
    ...
    public static final String OAUTH_CALLBACK = "http://localhost:8000/edusecure/oauth2client";

    public static final String CONSUMER_KEY = "uZ9Rh5dfdhS8RAfRho_QpCuaJoQa";

    public static final String CONSUMER_SECRET = "wxc6HNiZveR8k4UvP13mQFVloUEa";

    public static final String OAUTH_TOKEN = "oauth_token";

    public static final String OAUTH2_ACCESS_ENDPOINT = "accessEndpoint";

    public static final String OAUTH2_AUTHZ_ENDPOINT = "https://localhost:9443/oauth2/authorize";
